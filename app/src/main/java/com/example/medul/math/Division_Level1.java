...
public class Division_Level1 extends AppCompatActivity {
    ...
    private void onSubmitClick() {
        ...
        if (questionCount < questionArrayList.size()) {
            ...
            if (givenAnswerByUser.equalsIgnoreCase(questionArrayList.get(questionIndex).getCorrectAnswer())) {
                ...
                totalCorrectAnswer++;
                Toast.makeText(Division_Level1.this, "Right Answer", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(Division_Level1.this, "Wrong Answer", Toast.LENGTH_SHORT).show();
            }
            ...
            Toast.makeText(Division_Level1.this, "Total Mark: " + totalMark + "Total Correct Answer: " + totalCorrectAnswer, Toast.LENGTH_SHORT).show();
        }
