    ...
    private void onSubmitClick(){
        ...
        if(questionCount<questionArrayList.size()){
            ...
            if(givenAnswerByUser.equalsIgnoreCase(questionArrayList.get(questionIndex).getCorrectAnswer())){
                ...
                totalCorrectAnswer++;
                Toast.makeText(MultiLevel1.this, "Right Answer", Toast.LENGTH_SHORT).show();
            }
            else{
                Toast.makeText(MultiLevel1.this,"Wrong Answer",Toast.LENGTH_SHORT).show();
            }
            ...
            Toast.makeText(MultiLevel1.this,"Total Mark: "+ totalMark + "Total Correct Answer: "+totalCorrectAnswer, Toast.LENGTH_SHORT).show();
        }
